...
yum install -y docker jq bind-utils bridge-utils tcpdump dnsmasq haveged strace pstack htop iostat vmstat  sysdig pidstat mpstat iotop blktrace perf nicstat dstat ltrace
